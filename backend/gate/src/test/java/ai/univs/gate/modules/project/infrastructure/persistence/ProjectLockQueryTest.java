 ...
 * 재발급이 제거되고 UG-311 에서 프로젝트 수정이 합류해, 지금 잠그는 쓰기 경로는 삭제·수정 둘이다.
 *
 * <p>동시성 자체는 {@code ProjectUpdateDeleteRaceSliceTest} 가 H2 와 스레드 두 개로 재현한다 (UG-311).
 * 이 테스트는 그와 별개로 잠금 <b>선언</b>이 사라지는 회귀를 컴파일 수준에서 못박는다.
 */
