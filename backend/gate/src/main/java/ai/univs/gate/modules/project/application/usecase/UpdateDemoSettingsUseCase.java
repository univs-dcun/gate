...
public class UpdateDemoSettingsUseCase {

    private final ProjectService projectService;
    private final ProjectSettingsRepository projectSettingsRepository;

    @Transactional
    public ProjectSettingsResult execute(Long projectId, boolean demoEnabled) {
        ...
        settings.updateDemoSettings(demoEnabled);

        log.info("Demo settings updated: projectId={}, enabled={}",
                projectId,
                demoEnabled);
