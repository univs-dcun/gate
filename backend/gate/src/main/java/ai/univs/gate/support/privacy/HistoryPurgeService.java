 ...
 * 제5조의4 가 고객확인자료를 <b>금융거래등의 관계가 종료한 때부터 5년</b> 보존하도록 한다.
 * (전자금융거래법 제22조①·시행령 제12조① 도 거래기록 보존을 요구하지만 기산점 문언이 없고
 * 건당 1만원 이하는 1년이라, 1825일의 근거로 삼지 않는다.) gate 는 대개 수탁자이므로 그
 * 기간의 주인은 고객사다. 코드가 기본값을 정하면 <b>고객사의 법정 의무를 우리가 깨는</b>
 * 형태가 된다.
 *
