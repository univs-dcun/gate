...
public class ProjectService {
     ...
     *
     * <p>UG-302 때는 키 재발급과 프로젝트 삭제 두 곳이었다. UG-312 에서 재발급이 제거되고
     * UG-311 에서 {@code UpdateProjectUseCase} 가 합류해, 지금은 삭제·수정 두 경로가 이 잠금을 잡는다.
     * (수정이 잠그지 않던 동안에는 삭제가 커밋된 뒤 먼저 시작된 수정이 더티 체킹으로
     * {@code is_deleted} 를 되써 프로젝트를 부활시켰다.)
     *
