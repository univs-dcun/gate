...
public class HistoryPurgeScheduler {
     ...
     *
     * <p>특정금융정보법 제5조의4 의 고객확인자료와 전자금융거래법 시행령 제12조의 거래기록이
     * 모두 <b>거래 관계 종료 후 5년</b>이다. 이보다 짧은 값을 넣는 것이 <b>틀렸다는 뜻은
     * 아니다</b> — 출입문 게이트·B2B 납품처럼 금융 법령이 걸리지 않는 곳이 우리 타깃에 있고,
    ...
    public void purgeExpiredHistory() {
        ...
        if (retentionDays < 금융_법정_최소_보존일) {
            log.warn("""
                    ...
                    금융 납품이라면 특정금융정보법 제5조의4·전자금융거래법 시행령 제12조 위반이 된다. \
