...
public class UpdateSdkSettingsUseCase {

    private final ProjectService projectService;
    private final ProjectSettingsRepository projectSettingsRepository;

    @Transactional
    public ProjectSettingsResult execute(Long projectId, Boolean sdkBoolean) {
        ...
        settings.updateSdkSettings(sdkBoolean);

        log.info("SDK settings updated: projectId={}, enabled={}",
                projectId,
                sdkBoolean);
