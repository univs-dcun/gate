...
public record LivenessByTokenRequestDTO(
        @Schema(description = SwaggerDescriptions.LIVENESS_CODE, requiredMode = Schema.RequiredMode.REQUIRED)
        @NotBlank(message = "REQUIRED_LIVENESS_CODE")
