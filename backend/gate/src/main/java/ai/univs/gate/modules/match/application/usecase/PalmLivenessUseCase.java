...
import ai.univs.gate.modules.match.application.input.PalmLivenessInput;
...
import ai.univs.gate.modules.palm_media.infrastructure.client.dto.LivenessPalmFeignRequestDTO;
...
public class PalmLivenessUseCase {
    ...
    public PalmLivenessResult execute(PalmLivenessInput input) {
        ...
        MatchHistory matchHistory = MatchHistory.builder()
                .project(project)
                .matchType(MatchType.PALM_LIVENESS)
