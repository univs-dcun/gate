...
public record IdentifyByTokenRequestDTO(
        @Schema(description = SwaggerDescriptions.IDENTIFY_CODE, requiredMode = Schema.RequiredMode.REQUIRED)
        @NotBlank(message = "REQUIRED_IDENTIFY_CODE")
        @Length(min = 36, max = 36, message = "INVALID_IDENTIFY_CODE_LENGTH")
        String code,
