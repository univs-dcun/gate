...
public interface ProjectJpaRepository extends JpaRepository<Project, Long> {
     ...
     *
     * <p>잠그는 쓰기 경로는 프로젝트 삭제와 수정 둘이다 (수정은 UG-311 에서 합류). 수정이 잠금 없이
     * 읽던 동안에는 삭제가 커밋된 뒤 먼저 시작된 수정이 더티 체킹으로 {@code is_deleted} 를 되써
     * 프로젝트를 부활시켰다 — {@code ProjectUpdateDeleteRaceSliceTest} 가 그 회귀를 잡는다.
     *
