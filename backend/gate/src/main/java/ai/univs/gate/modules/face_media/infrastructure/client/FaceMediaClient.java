package ai.univs.gate.modules.face_media.infrastructure.client;
...
import ai.univs.gate.modules.face_media.infrastructure.client.dto.FaceFeignResponseDTO;
...
@FeignClient(
        name = "face-service",
        contextId = "faceMediaClient",
        configuration = CommonFeignConfig.class
)
public interface FaceMediaClient {
