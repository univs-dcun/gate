...
ALTER TABLE face_media ADD external_key VARCHAR2(255) DEFAULT NULL;
...
ALTER TABLE match_history ADD media_type VARCHAR2(10) DEFAULT 'FACE';
UPDATE match_history SET media_type = 'FACE';
ALTER TABLE match_history MODIFY media_type VARCHAR2(10) NOT NULL;
