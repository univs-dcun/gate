...
ALTER TABLE face_feature ADD external_key VARCHAR2(255) DEFAULT NULL;
...
ALTER TABLE match_history ADD feature_type VARCHAR2(10) DEFAULT 'FACE';
UPDATE match_history SET feature_type = 'FACE';
ALTER TABLE match_history MODIFY feature_type VARCHAR2(10) NOT NULL;
