...
CREATE TABLE companies (
    ...
    manager_mail        VARCHAR(255)    DEFAULT '',
    manager_name        VARCHAR(100)    DEFAULT '',
    manager_number      VARCHAR(100)    DEFAULT '',
    main_service        VARCHAR(100)    DEFAULT '',
...
CREATE TABLE consent_logs (
    consent_log_id          BIGSERIAL       NOT NULL,
    project_id              BIGINT          NOT NULL,
    end_user_identifier     BIGINT          NOT NULL,
...
CREATE TABLE match_history (
    match_history_id        BIGSERIAL       NOT NULL,
    project_id              BIGINT          NOT NULL,
    ...
    face_id                 VARCHAR(100)    DEFAULT '',
    user_description        VARCHAR(1000)   DEFAULT '',
    similarity              DECIMAL(5,2)    DEFAULT 0.00,
    face_image_path         VARCHAR(100)    DEFAULT '',
    match_face_image_path   VARCHAR(100)    DEFAULT '',
    match_face_id           VARCHAR(100)    DEFAULT NULL,
    failure_type            VARCHAR(100)    DEFAULT '',
    failure_reason          VARCHAR(1000)   DEFAULT '',
...
CREATE TABLE project_settings (
    ...
    liveness_recording_enabled      BOOLEAN     NOT NULL DEFAULT FALSE,
    liveness_identifying_enabled    BOOLEAN     NOT NULL DEFAULT FALSE,
    liveness_verifying_enabled      BOOLEAN     NOT NULL DEFAULT FALSE,
    created_at                      TIMESTAMP   NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at                      TIMESTAMP   NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE projects (
    ...
    project_description     VARCHAR(1000)   DEFAULT '',
    status                  VARCHAR(20)     DEFAULT 'ACTIVE',
    project_type            VARCHAR(20)     NOT NULL DEFAULT 'STANDARD',
    project_module_type     VARCHAR(20)     NOT NULL DEFAULT 'FACE',
    package_key             VARCHAR(99)     DEFAULT NULL,
...
CREATE TABLE users (
    ...
    face_image_path     VARCHAR(255)    DEFAULT '',
