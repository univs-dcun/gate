...
CREATE TABLE accounts (
    account_id              NUMBER(20,0)    GENERATED ALWAYS AS IDENTITY NOT NULL,
    email                   VARCHAR2(255)   NOT NULL,
    password                VARCHAR2(255)   NOT NULL,
    status                  VARCHAR2(20)    DEFAULT 'ACTIVE',
    failed_login_attempts   NUMBER(11,0)    DEFAULT 0,
    locked_until            TIMESTAMP       DEFAULT NULL,
    last_login_at           TIMESTAMP       DEFAULT NULL,
    last_login_ip           VARCHAR2(45)    DEFAULT NULL,
...
CREATE TABLE email_verifications (
    verification_id     NUMBER(20,0)    GENERATED ALWAYS AS IDENTITY NOT NULL,
    type                VARCHAR2(30)    NOT NULL,
    email               VARCHAR2(255)   NOT NULL,
    verification_code   VARCHAR2(255)   NOT NULL,
    created_at          TIMESTAMP       DEFAULT CURRENT_TIMESTAMP,
    expires_at          TIMESTAMP       NOT NULL,
    verified            NUMBER(1,0)     DEFAULT 0,
    verified_at         TIMESTAMP       DEFAULT NULL,
    attempts            NUMBER(11,0)    DEFAULT 0,
...
COMMENT ON COLUMN email_verifications.verified          IS '메일 인증 여부 (0=false, 1=true)';
...
CREATE TABLE login_logs (
    log_id          NUMBER(20,0)    GENERATED ALWAYS AS IDENTITY NOT NULL,
    account_id      NUMBER(20,0)    DEFAULT NULL,
    login_status    VARCHAR2(50)    NOT NULL,
    attempted_email VARCHAR2(255)   DEFAULT NULL,
...
CREATE TABLE password_histories (
    history_id              NUMBER(20,0)    GENERATED ALWAYS AS IDENTITY NOT NULL,
    account_id              NUMBER(20,0)    NOT NULL,
    password_hash           VARCHAR2(255)   NOT NULL,
    changed_at              TIMESTAMP       DEFAULT CURRENT_TIMESTAMP,
    password_reset_method   VARCHAR2(30)    NOT NULL,
    ip_address              VARCHAR2(45)    DEFAULT NULL,
    user_agent              CLOB            DEFAULT NULL,
...
CREATE TABLE refresh_tokens (
    token_id    NUMBER(20,0)    GENERATED ALWAYS AS IDENTITY NOT NULL,
    account_id  NUMBER(20,0)    NOT NULL,
    jti         VARCHAR2(255)   NOT NULL,
    token_hash  VARCHAR2(255)   DEFAULT NULL,
...
COMMENT ON COLUMN refresh_tokens.is_revoked IS '리프래시 토큰 무효화 여부 (0=false, 1=true)';
