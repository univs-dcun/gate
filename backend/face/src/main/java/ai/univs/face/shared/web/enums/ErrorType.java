package ai.univs.face.shared.web.enums;
...
public enum ErrorType {
    ...
    // Face
    NOT_FACE_IMAGE("FACE-001", HttpStatus.BAD_REQUEST),
    NOT_MATCH("FACE-003", HttpStatus.BAD_REQUEST),
    MISMATCH("FACE-004", HttpStatus.BAD_REQUEST),
    NO_DOUBLE_SIMILARITY("FACE-005", HttpStatus.BAD_REQUEST),
    TOO_MANY_FACES("FACE-007", HttpStatus.BAD_REQUEST),
    FACE_NOT_FOUND("FACE-008", HttpStatus.BAD_REQUEST),
    ;
