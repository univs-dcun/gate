...
- 화면 스펙 부모 페이지: Gate Service > 화면 스펙
...
### [Step 5] Notion 화면 스펙 페이지 생성 — 작업 완료 후 필수
docs/screen-spec-template.md 형식으로 Notion 페이지를 생성한다.
포함 항목: Figma 원본 링크/스크린샷, 확정 API 계약, 생성 파일 목록, 예상 동작, 이슈 이력(초기 빈칸)
